...
/** the function prototypes of the functions accessible to an application 
*** are as follows:-
**/
...
short _declspec (dllexport)  WINAPI MicrolinkFrameDetails ( short nIMLDev, short
                  *lpnType, short  * lpnRealAddress );
